...
import { getFirestore, doc, setDoc, getDocs, collection, query, orderBy, onSnapshot, getDocFromServer } from 'firebase/firestore';
...
// Log initialization status (helpful for debugging deployment issues)
